...
\newcommand\companyname{GetYourGuide}

\recipient
  {{\companyname} Recruitment Team}
  {{\companyname}\\Berlin, Berlin, Germany}
  % {Google Inc.\\1600 Amphitheatre Parkway\\Mountain View, CA 94043}
% The date on the letter, default is the date of compilation
\letterdate{\today}
% \letterdate{}
% The title of the letter
\lettertitle{Job Application for Senior Data Scientist, Data Product (Recommendations and Relevance)}
