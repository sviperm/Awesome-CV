...
\newcommand\companyname{Justtrack}

\recipient
  {{\companyname} Recruitment Team}
  {{\companyname}\\Hamburg, Germany}
  % {Google Inc.\\1600 Amphitheatre Parkway\\Mountain View, CA 94043}
% The date on the letter, default is the date of compilation
\letterdate{\today}
% \letterdate{}
% The title of the letter
\lettertitle{Data Scientist (f/m/d)}
...
%   \item {At BARS Group I succesfully engineered two NLP projects from developement to integration.}
  ...
  \item {My personal project that I am proud of is the neuro-comma - neural network solution for the repunctuation task for the Russian language. After spending some time on research I found that there is no high-quality open-sourced solution for such a task, so I said: "Fine, I'll do it myself". Russian NLP community appreciated my contribution, even though my colleagues said that they used my model for some hackathon before we became colleagues.}
  \item {Desired salary - at least 72k EUR gross, annual}
  \item {Earliest possible start date - that depends on relocation time, but I want to join your team as fast as I can!}
