...
\newcommand\companyname{Trivago}

\recipient
  {{\companyname} Recruitment Team}
  {{\companyname}\\Düsseldorf, North Rhine-Westphalia, Germany}
  % {Google Inc.\\1600 Amphitheatre Parkway\\Mountain View, CA 94043}
% The date on the letter, default is the date of compilation
\letterdate{\today}
% \letterdate{}
% The title of the letter
\lettertitle{Job Application for Data Scientist - Performance Marketing}
